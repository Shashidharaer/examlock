            ...
            <div className='mx-auto max-w-7xl'>
                ...
                <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 md:flex-row">
                    <div className="w-full md:w-1/2">
                        <Card className="mx-auto max-w-lg shadow-sm md:mx-0 md:max-w-none">
                    ...
                    <div className="flex w-full items-center justify-center rounded-lg bg-white p-4 text-center font-medium text-gray-700 shadow-sm sm:p-6 md:w-1/2">
