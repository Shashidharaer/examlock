...
export default function IntelligentMonitoring({ badge_text, title, details }: IntelligentMonitoringProps) {
  return (
    <section className="w-full my-10 md:my-20 px-4">
      <div className="max-w-7xl mx-auto flex flex-col gap-4 justify-center items-center bg-white font-light p-6 sm:p-8 md:p-11 w-full rounded-3xl shadow-lg/1 my-10 md:my-20">
