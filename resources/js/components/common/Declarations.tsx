...
export default function Declarations({ badge_title, title, description, para }: DeclarationsProps) {
    return (
        <section className="mb-10 mt-0.5 w-full  px-4 md:mb-20">
            <div className="flex flex-col mx-auto max-w-7xl items-center gap-8 rounded-lg bg-white px-4 pb-16 pt-8 md:px-20">
