...
const countries: Country[] = [
    ...
    { code: 'VC', name: 'Saint Vincent', dialCode: '+1-784', flag: '🇻🇨' },
...
export default function CountryCodeSelector({
    ...
    const selectedCountry = countries.find((c) => c.code === selectedCountryCode && c.dialCode === value) 
    ...
    const handleSelect = (dialCode: string, countryCode: string) => {
    ...
    return (
        <div className={`relative ${className}`}>
            <button
                ...
                className="flex h-full items-center gap-1 rounded-l border border-r-0 bg-gray-50 px-3 text-sm hover:bg-gray-100 md:text-base"
            >
            ...
            {isOpen && (
                <>
                    ...
                    {/* Dropdown */}
                    <div className="absolute left-0 top-full z-20 mt-1 w-72 rounded-lg border bg-white shadow-lg">
                        {/* Search */}
                        <div className="border-b p-2">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full rounded border py-1.5 pl-8 pr-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    autoFocus
                                />
                            </div>
                        </div>
                            ...
                            {filteredCountries.length > 0 ? (
                                filteredCountries.map((country) => (
                                    <button
                                        key={country.code}
                                        type="button"
                                        onClick={() => handleSelect(country.dialCode, country.code)}
                                        className={`flex w-full items-center gap-3 px-3 py-2 text-left text-sm hover:bg-gray-100 ${
                                            country.code === selectedCountryCode && country.dialCode === value
                                                ? 'bg-blue-50'
                                                : ''
                                        }`}
                                    >
