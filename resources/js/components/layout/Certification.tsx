...
export default function Certification({
  ...
  const badges = [
    { label: "GDPR", src: "/products/GDPR.svg" },
    { label: "COPPA", src: "/products/COPPA.svg" },
    { label: "FERPA", src: "/products/FERPA.svg" },
    { label: "ISO 9001:2015", src: "/products/ISO 9001_2015.svg" },
    { label: "ISO 27001:2022", src: "/products/ISO 27001_2022.svg" },
    { label: "ISO 27701:2019", src: "/products/ISO 27701_2019.svg" },
    { label: "PCI DSS", src: "/products/PCI DSS.svg" },
    { label: "SOC 2 II", src: "/products/SOC2 II.svg" },
  ];
