...
import scaffold26a789 from './scaffold'
...
/**
* @see \Statamic\Http\Controllers\CP\Collections\ScaffoldCollectionController::scaffold
 ...
 */
export const scaffold = (args: { collection: string | number } | [collection: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: scaffold.url(args, options),
    method: 'get',
})
 ...
 * @route '/cp/collections/{collection}/scaffold'
 */
scaffold.url = (args: { collection: string | number } | [collection: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { collection: args }
    }
    ...
    return scaffold.definition.url
            .replace('{collection}', parsedArgs.collection.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/cp/collections/{collection}/scaffold'
 */
scaffold.get = (args: { collection: string | number } | [collection: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: scaffold.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/cp/collections/{collection}/scaffold'
 */
scaffold.head = (args: { collection: string | number } | [collection: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: scaffold.url(args, options),
    method: 'head',
})
 ...
 * @route '/cp/collections/{collection}/scaffold'
 */
    const scaffoldForm = (args: { collection: string | number } | [collection: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: scaffold.url(args, options),
        method: 'get',
    })
 ...
 * @route '/cp/collections/{collection}/scaffold'
 */
        scaffoldForm.get = (args: { collection: string | number } | [collection: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: scaffold.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/cp/collections/{collection}/scaffold'
 */
        scaffoldForm.head = (args: { collection: string | number } | [collection: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: scaffold.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
...
scaffold: Object.assign(scaffold, scaffold26a789),
