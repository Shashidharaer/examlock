 ...
 */
    ...
    edit.form = editForm
/**
* @see \Statamic\Http\Controllers\CP\Collections\EntryPreviewController::popout
 * @see vendor/statamic/cms/src/Http/Controllers/CP/Collections/EntryPreviewController.php:13
 * @route '/cp/collections/{collection}/entries/{entry}/preview'
 */
export const popout = (args: { collection: string | number, entry: string | number } | [collection: string | number, entry: string | number ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/cp/collections/{collection}/entries/{entry}/preview'
 */
popout.url = (args: { collection: string | number, entry: string | number } | [collection: string | number, entry: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    collection: args[0],
                    entry: args[1],
 ...
 * @route '/cp/collections/{collection}/entries/{entry}/preview'
 */
popout.get = (args: { collection: string | number, entry: string | number } | [collection: string | number, entry: string | number ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: popout.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/cp/collections/{collection}/entries/{entry}/preview'
 */
popout.head = (args: { collection: string | number, entry: string | number } | [collection: string | number, entry: string | number ], options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: popout.url(args, options),
    method: 'head',
})
 ...
 * @route '/cp/collections/{collection}/entries/{entry}/preview'
 */
    const popoutForm = (args: { collection: string | number, entry: string | number } | [collection: string | number, entry: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/cp/collections/{collection}/entries/{entry}/preview'
 */
        popoutForm.get = (args: { collection: string | number, entry: string | number } | [collection: string | number, entry: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: popout.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/cp/collections/{collection}/entries/{entry}/preview'
 */
        popoutForm.head = (args: { collection: string | number, entry: string | number } | [collection: string | number, entry: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
